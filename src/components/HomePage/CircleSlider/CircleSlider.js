...
const category_array = [
    { category_name: text.CordlessTools, id: '121', category_url: `/product-category/Cordless-Tools` },
    { category_name: text.Accessories, id: '122', category_url: `/product-category/Accessories` },
    { category_name: text.WeldingTools, id: '123', category_url: `/product-category/Welding-Tools` },
    { category_name: text.ToolBox, id: '124', category_url: `/product-category/Tool-Box1` },
    { category_name: text.HandlingEquipment, id: '125', category_url: `/product-category/Handling-Equipment` },
    { category_name: text.SafetyTools, id: '126', category_url: `/product-category/Safety-Tools` },
    { category_name: text.PrecisionMeasuringTools, id: '127', category_url: `/product-category/Precision-and-Measuring-Tools` },
    { category_name: text.PowerTools, id: '128', category_url: `/product-category/Power-Tools` },
    { category_name: text.PneumaticTools, id: '129', category_url: `/product-category/Pneumatic-Tools` },
    { category_name: text.LighteningTools, id: '130', category_url: `/product-category/Lightening-Tools` },
    { category_name: text.HandTools, id: '131', category_url: `/product-category/Hand-Tools` },
    { category_name: text.GardeninnTools, id: '132', category_url: `/product-category/Gardening-Tools` },
]

const CircleSlider = () => {
    const router = useRouter()
    const EventFunction = () => {
        $('.circle-slider .circle-obj svg>g>g').mouseover(function () {

            let array_index = parseInt($(this).attr('data-index') - 1);
            $('.content-circle-slider .category-name').text(category_array[array_index].category_name).addClass('name-category-show');

            jquery('.circle-slider .circle-obj svg>g>g').removeClass('active-item');
            jquery(this).addClass('active-item');
        })
        $('.circle-slider .circle-obj svg>g>g').mouseleave(function () {
            $('.content-circle-slider .category-name').removeClass('name-category-show');
            jquery('.circle-slider .circle-obj svg>g>g').removeClass('active-item');
        })
        $('.open-circle-slider').click(function () {
            $(this).addClass('hidden')
            $('.circle-obj').removeClass('hidden')
        })
        $('.close-circle-slider').click(function () {
            $('.circle-obj ').addClass('hidden')
            $('.open-circle-slider').removeClass('hidden')
        })
    }
    useEffect(() => {
        EventFunction();
        $('.circle-slider .circle-obj svg>g>g').click(function () {
            let array_index = parseInt($(this).attr('data-index') - 1);
            router.push(category_array[array_index].category_url)
            $('.circle-obj ').addClass('hidden')
            $('.open-circle-slider').removeClass('hidden')
        })
    ...
    return (
        <div className={'circle-slider col-12 px-0 circle-fixed d-none d-lg-block'}>

            <div className={'circle-obj all-transition hidden'}>
                <div className={'content-circle-slider text-center'}>
                    <p className={'mb-2 font-19 category-name'}></p>
                    <p className={'mb-2 font-19 defualt-preview'}>{text.ProductCategory}</p>
                </div>
                <button className={'close-circle-slider mt-2 all-transition'}>
                    <span></span>
                    <span></span>
                </button>
                <a href={`${assetPrefix}/catalogs/1`} className='dw-cl cursor-pointer'>
                    <i className="fa font-14 mr-1 fa-download"></i>
                    {text.DownloadCatalogue}
                </a>

                <img src={`${internationalAssets}/img/general-img/back-circle-slider.svg`} />
                <svg xmlns="http://www.w3.org/2000/svg" width="430" height="459.947" viewBox="0 0 430 459.947">
                    <defs>
                        <filter id="Path_86" x="317.769" y="137.439" width="112.231" height="119.508"
                        ...
                        <clipPath id="clip-path">
                            <rect id="Rectangle_223" data-name="Rectangle 223" width="61.347" height="50.173"
                                fill="#fff" />
                        </clipPath>
                        <filter id="Path_85" x="271.943" y="63.203" width="130.88" height="130.947"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <clipPath id="clip-path-2">
                            <rect id="Rectangle_224" data-name="Rectangle 224" width="59.532" height="62.094"
                                fill="#fff" />
                        </clipPath>
                        <filter id="Path_84" x="173.099" y="0" width="191.652" height="184.309"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <clipPath id="clip-path-3">
                            <rect id="Rectangle_225" data-name="Rectangle 225" width="56.522" height="51.387"
                                fill="#ececec" />
                        </clipPath>
                        <filter id="Path_81" x="6" y="137.439" width="112.232" height="119.508"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <clipPath id="clip-path-4">
                            <rect id="Rectangle_226" data-name="Rectangle 226" width="41.203" height="31.456"
                                fill="#fff" />
                        </clipPath>
                        <filter id="Path_82" x="33.178" y="63.203" width="130.88" height="130.947"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <clipPath id="clip-path-5">
                            <rect id="Rectangle_227" data-name="Rectangle 227" width="48.899" height="34.485"
                                fill="#fff" />
                        </clipPath>
                        <filter id="Path_83" x="107.576" y="36" width="119.652" height="112.309"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <clipPath id="clip-path-6">
                            <rect id="Rectangle_229" data-name="Rectangle 229" width="51.387" height="51.387"
                                fill="#fff" />
                        </clipPath>
                        <filter id="Path_87" x="317.49" y="238.947" width="112.509" height="119.998"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <filter id="Path_80" x="0" y="232.947" width="124.51" height="131.998"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <clipPath id="clip-path-7">
                            <rect id="Rectangle_232" data-name="Rectangle 232" width="56.155" height="37.423"
                                fill="#fff" />
                        </clipPath>
                        <filter id="Path_79" x="33.456" y="302.236" width="130.89" height="130.621"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <clipPath id="clip-path-8">
                            <rect id="Rectangle_233" data-name="Rectangle 233" width="36.383" height="56.742"
                                fill="#fff" />
                        </clipPath>
                        <filter id="Path_78" x="107.625" y="347.803" width="119.376" height="112.145"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <clipPath id="clip-path-9">
                            <rect id="Rectangle_234" data-name="Rectangle 234" width="68.759" height="57.896"
                                fill="#fff" />
                        </clipPath>
                        <filter id="Path_76" x="271.654" y="302.236" width="130.891" height="130.621"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
                        ...
                        <clipPath id="clip-path-10">
                            <rect id="Rectangle_235" data-name="Rectangle 235" width="38.223" height="62.651"
                                fill="#fff" />
                        </clipPath>
                        <filter id="Path_77" x="208.999" y="347.801" width="119.375" height="112.146"
                            filterUnits="userSpaceOnUse">
                            <feOffset dy="3" input="SourceAlpha" />
            ...
            <div className={'open-circle-slider all-transition text-center'}>
                <span className={'d-block px-0 font-11  c-red'}>
                    {text.RonixTools}
                </span>
                <span className={'d-block px-0 c-red c-white font-weight-bold font-11'}>
                    {text.Category}
                </span>
            </div>
        </div >
