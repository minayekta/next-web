...
const TagsCategoryAccordion = ({ Data }) => {
    ...
    try {
        return (
            <aside className={`col-md-12 px-0 mb-3 accordion-show d-none d-xl-block ${isRtl ? 'rtl' : ''}`}>
                                                        ...
                                                        item.childs.map((child) =>
                                                            <Link href={`/product-category/${child.productCategoryAttributes[0].permalink}`} >
                                                                <a className=" categoryaccordion-listACcordion">
                                                                    <li className={`pl-3 ml-3 categoryaccordion-item font-14 ${isRtl ? ' rtl-item ' : ' '}`}>{child.productCategoryAttributes[0].title}</li>
                                                                </a>
                                                            </Link>

                                                        ))}
                                                    <a className=" categoryaccordion-listACcordion" href={`/product-category/${item.productCategoryAttributes[0].permalink}`}>
                                                        <li className={`pl-3 ml-3 categoryaccordion-item font-14 ${isRtl ? ' rtl-item ' : ' '}`}>
                                                ...
                                                <ul className="categoryaccordion-list-body  all-transition m-0 categoryaccordion-lineheight">
                                                    ...
                                                    {Children.toArray(
                                                        item.childs.map((child) =>
                                                            <Link href={`/product-category/${child.productCategoryAttributes[0].permalink}`} >
                                                                <a className=" categoryaccordion-listACcordion">
                                                                    <li className="pl-3  ml-3 categoryaccordion-item font-14">{child.productCategoryAttributes[0].title}</li>
                                                                </a>
                                                            </Link>
                                                        ))}
                                                    <a className=" categoryaccordion-listACcordion" href={`/product-category/${item.productCategoryAttributes[0].permalink}`}>
...
export default TagsCategoryAccordion;