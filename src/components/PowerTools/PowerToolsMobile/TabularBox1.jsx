    ...
    return (
        <div className="col-12 pt-5" >
            ...
            <div className="col-mb wow fadeInUp tab-content" id="pills-gridingTabContent">
                <div className="tab-pane p-3 bg-light text-dark fade active show" id="griding-one" role="tabpanel" aria-labelledby="griding-one-tab">
                    <p itemProp="description" className="text-justify">
                        {props.paragraph}
                    </p>
                </div>
                <div className="tab-pane p-3 bg-light text-dark fade" id="griding-two" role="tabpanel" aria-labelledby="griding-two-tab">
                    <p itemprop="description" className="text-justify">
                        {props.paragraph1}
                    </p>
                </div>
